...
def draw_game_over():
    ...
    screen.draw.text("GAME OVER", midbottom=screen_middle, fontsize=GRID_SIZE, color="green", owidth=1)
    
    if player_won:
        screen.draw.text("You won!", midtop=screen_middle, fontsize=GRID_SIZE, color="purple", owidth=1)
    else:
        screen.draw.text("You lost!", midtop=screen_middle, fontsize=GRID_SIZE, color="orange", owidth=1)
